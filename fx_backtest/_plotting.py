...
return this.labels[index] || "";
    ...
    def _plot_pl_section():
        ...
        # if 'TakeProfit' in trades:
        #     trade_source.add(trades['TakeProfit'], 'tp')
        # if 'StopLoss' in trades:
        #     trade_source.add(trades['StopLoss'], 'sl')
        if "count" in trades:
        ...
        if "TakeProfit" in trades:
            tooltips.append(("TP", "@tp"))
        if "StopLoss" in trades:
            tooltips.append(("SL", "@sl"))
        if "count" in trades:
